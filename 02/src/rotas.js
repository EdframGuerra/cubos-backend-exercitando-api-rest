...
const { removerConvidado } = require('./controladores/convidados');
const { adicionarConvidado } = require('./controladores/convidados');
...
rotas.delete('/convidados', convidados.removerConvidado)//excluir um convidado da lista
